...
grtp generates and maintains several file formats for release management and documentation. This guide covers the structure and purpose of each file type.
...
- name: Generate Release Files
  run: python grtp.py --release-prepare
